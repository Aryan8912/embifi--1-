                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: AlignmentDirectional(1, -0.24),
                            child: Container(
                              width: 690,
                              height: 250,
                              decoration: BoxDecoration(
                              ...
                              child: Stack(
                                children: [
                                  ...
                                  Align(
                                    alignment:
                                        AlignmentDirectional(0.64, -0.97),
                                    child: FlutterFlowIconButton(
                                      borderColor: Colors.transparent,
                                      borderRadius: 30,
                                      borderWidth: 1,
                    ...
                    child: Stack(
                      children: [
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(9, 175, 0, 0),
                            child: InkWell(
                              onTap: () async {
                        ...
                        Align(
                          ...
                          child: Padding(
                            padding:
                                EdgeInsetsDirectional.fromSTEB(60, 15, 0, 0),
                            child: InkWell(
                              onTap: () async {
                                context.pushNamed(
                                  'Partners',
